...
<div id="new">
    <div class="text1">
        <a class="main_color"  href="create.php" style="text-align: center">Добавить</a>
    </div>
    <div class="menu" style="margin-top: 3%; height: 1000px; " >
        ...
        foreach ($items as $item) {
            ...
            <div class="mbox2" style="width: 400px; height: 550px">
                ...
                <a class="main_color" href="update.php?ID=<?php echo $item['ID'] ?>">Обновить</a>
                <br>
                <a class="main_color" href="delete.php?ID=<?php echo $item['ID'] ?>">Удалить</a>
                <br>
            </div>
